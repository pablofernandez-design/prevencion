...
(function () {
  ...
  const AREAS = {
    ...
    'nutricion': { name:'Nutrición', cat:'cat-nutricion', icon:'i-apple', fg:'dark', score:'8/10', status:'green', statusLabel:'SIGUE ASÍ',
      escalasByReport:{
        ...
        1:[ {t:'Índice de Masa Corporal (IMC)', tag:'Peso saludable', variant:'green', d:'El IMC es una medida para evaluar si una persona tiene un peso saludable en relación con su altura (kg/m²).', rangos:['<18,5: Peso insuficiente','18,5–24,9: Peso saludable','25–29,9: Sobrepeso','30–34,9: Obesidad tipo I','35–39,9: Obesidad tipo II','40–49,9: Obesidad tipo III','>50: Obesidad tipo IV']},
            {t:'Cuestionario MEDAS: adherencia a la dieta mediterránea', tag:'Buena adherencia', variant:'green', d:'MEDAS evalúa el grado de adherencia a la dieta mediterránea mediante 14 ítems sobre frecuencia y tipo de alimentos.', rangos:['Baja adherencia (<9 puntos)','Buena adherencia (≥9 puntos)']} ] } },
    'mente-activa': { name:'Mente Activa', cat:'cat-mente', icon:'i-brain', fg:'light', score:'9/10', status:'green', statusLabel:'SIGUE ASÍ',
      escalas:[ {t:'Test de Pfeiffer', tag:'Ausencia de deterioro cognitivo', variant:'green', d:'Prueba de cribado para detectar posibles signos de deterioro cognitivo (10 preguntas: memoria, atención, razonamiento y cálculo).', rangos:['8–10: posible deterioro cognitivo severo.','5–7: posible deterioro cognitivo moderado.','3–4: posible deterioro cognitivo leve.','0–2: ausencia de posible deterioro cognitivo.']} ] },
  ...
  const PAUTAS = {
    ...
    'nutricion': { type:'numbered',
      ...
      items:[
        {t:'Verduras y hortalizas', body:'**Las verduras y hortalizas son una importante fuente de vitaminas, minerales, fibra y antioxidantes. Consume hortalizas, como mínimo 2 veces al día,** crudas (en ensaladas bien variadas) o cocidas (al vapor, salteadas, al horno, etc.), como plato principal o de acompañamiento.\n\n1 ración de hortalizas equivale a:', bullets:['1 plato de ensalada.','1 plato de verdura cocida (judía tierna, menestra…).','1-2 tomates, zanahorias o pepinos.','1 pimiento, 1 calabacín.']},
        {t:'Fruta', body:'**El consumo de al menos 3 raciones de fruta al día contribuye a una alimentación saludable y a la prevención de múltiples enfermedades.**\n\nConsume la fruta entera o a trozos, evita tomar zumos de fruta aunque sea natural. También puedes consumir fruta desecada y deshidratada: pasas, higos secos, ciruelas pasas, etc.\n\n1 ración de fruta equivale a:', bullets:['1 naranja, plátano, manzana, pera, melocotón, nectarina.','1-2 cortes de melón, sandía, piña.','1 bol de cerezas, fresas y uva.','2-3 albaricoques, ciruelas, mandarinas, frutos rojos.']},
        {t:'Legumbres', body:'**Las legumbres son una excelente fuente de proteínas, fibras, vitaminas y minerales esenciales. También son bajas en grasas saturadas y no contienen colesterol.**\n\nSegún la Organización Mundial de la Salud, una ingesta adecuada de legumbres (judías, lentejas, guisantes, garbanzos, etc.) puede ayudar a reducir el riesgo de enfermedades cardiovasculares, diabetes tipo 2, obesidad y ciertos tipos de cáncer.\n\n**Consume legumbres de 3 a 4 veces a la semana.** Se pueden cocinar y presentar de muchas maneras diferentes, y es fácil comprarlas cocidas.'},
        {t:'Frutos secos', body:'**Los frutos secos contienen fibra, grasas saludables, proteínas, vitaminas, minerales y sustancias fitoquímicas protectoras. Consúmelos sin sal ni azúcar, y evita comerlos fritos,** ya que suelen emplear aceites poco recomendables y añaden mucha sal.\n\n**Se recomienda consumir una porción pequeña de frutos secos al día, que generalmente es alrededor de 30 gramos (aproximadamente un puñado).**\n\nSi tienes alergia a los frutos secos, tales como las nueces, almendras, avellanas, pistachos, entre otros, debes evitar su consumo y buscar otras alternativas de alimentos saludables.'},
        {t:'Cereales integrales', body:'Los cereales integrales y alimentos con harinas integrales son ricos en almidón, en fibras, vitaminas del grupo B y otros micronutrientes. **Son opciones recomendables el maíz, mijo, avena, trigo o arroz integral sin procesar.**\n\n**Se recomienda un consumo diario,** controlando el tamaño de las porciones y limitando los cereales procesados y azucarados.\n\n**Trucos para consumir más cereales integrales.**', bullets:['Compra solo las variedades integrales de los derivados de los cereales: pan integral, arroz integral, pasta integral, cuscús integral, etc.','Escoge alimentos integrales mínimamente procesados, que solo contengan el cereal en cuestión o cuantos menos ingredientes mejor.']},
        {t:'Aceite de oliva virgen', body:'**El aceite de oliva virgen es una fuente importante de energía,** ya que está compuesto en su totalidad por grasas. Aunque la aportación calórica es la misma que la de otros aceites vegetales, el tipo de grasas que contiene hace que el consumo se relacione con menos riesgo de padecer enfermedades cardiovasculares y algún tipo de cáncer.\n\nDe una forma orientativa, se recomienda el **consumo de entre 4 y 6 raciones de aceite de oliva al día**, teniendo en cuenta que una ración equivale a una cucharada sopera (10 ml) de aceite.'},
        {t:'Pescado y huevos', body:'Los pescados son una buena fuente de proteínas de elevada calidad, vitamina D y yodo, y son muy ricos en ácidos grasos poliinsaturados omega-3, especialmente pescados azules. **La recomendación de consumo de pescado es de 2-3 veces a la semana.**\n\nLos huevos nos aportan proteínas de elevada calidad, vitaminas (A, D y B12) y minerales (fósforo y selenio). **La recomendación de consumo de huevos es de 3-4 veces a la semana.**'},
        {t:'Carne roja procesada', body:'La carne es un alimento rico en proteínas, algunos minerales y vitaminas. Contiene diferentes cantidades de grasas en función del animal y la parte. La Organización Mundial de la Salud recomienda **reducir el consumo de carne roja y de carne procesada,** puesto que el consumo excesivo se relaciona con un incremento del riesgo de ciertos problemas de salud (enfermedades cardiovasculares, hipertensión arterial, exceso de peso, diabetes mellitus de tipo 2, cáncer, etc.).\n\nLa alimentación debe ser basada preferentemente en alimentos de origen vegetal, **se puede consumir carne de 3 a 4 veces a la semana** (máximo de 1 a 2 raciones de estas de carne roja).'},
        {t:'Sal', body:'La sal es un condimento alimentario formado por cloruro de sodio. Ni el cloro ni el sodio de la sal son imprescindibles, ya que son elementos que se encuentran en muchos otros alimentos. En cambio, **el consumo excesivo de sal se relaciona con mayor prevalencia de enfermedades** (hipertensión arterial, infartos, ictus, cáncer de estómago y mortalidad en general).\n\nConsume menos de 5 gramos (aproximadamente una cucharadita) al día.\n\n**Trucos para reducir el consumo de sal:**', bullets:['Minimiza la cantidad de sal que añades a los alimentos.','Reduce al máximo la ingesta de alimentos procesados ricos en sal, especialmente los ultraprocesados como patatas chips, embutidos, jamón de York, jamón serrano, galletas, salsas, conservas y platos precocinados, entre otros.','Fíjate en la cantidad de sal que contienen los alimentos o productos. Se considera que un producto tiene “mucha sal” cuando tiene 1,25 o más gramos de sal por cada 100 gramos, mientras se considera que aporta “poca sal” cuando tiene 0,25 gramos (o menos) de sal por cada 100 gramos de alimento.','Sustituye la sal por especias (pimienta, clavo, canela, comino, cardamomo, nuez moscada, etc.), hierbas aromáticas (albahaca, perejil, cebollino, romero, orégano, laurel, tomillo, etc.) y otros condimentos (picada de ajo y perejil, zumo de limón, sésamo, pipas peladas sin sal, vinagre, ajo en polvo, etc.).','Escoge frutos secos sin sal.','Ten en cuenta que las salsas, en general, suelen tener mucha sal. En particular, la salsa de soja tiene mucha sal.']},
        {t:'Azúcar', body:'La Organización Mundial de la Salud recomienda que **la ingesta de azúcares libres no sobrepase el 10% de la energía total consumida al día, a pesar de que se indica que una ingesta de menos del 5% tendría beneficios para la salud adicionales.**\n\nNo es necesario consumir azúcares añadidos de ningún tipo, ya que la glucosa que necesita el organismo proviene de los alimentos farináceos, algunas hortalizas, leche y legumbres.\n\nNo existe un consumo seguro de azúcar; cuanto menos, mejor.\n\n**Trucos para reducir el consumo de azúcar:**', bullets:['Evita al máximo alimentos procesados y ultraprocesados, tales como bollería, galletas, cereales del desayuno, postres lácteos, fruta en almíbar, entre otras.','Minimiza la cantidad de azúcar que añades al café e infusiones.','Utiliza la fruta para endulzar alimentos como el yogur.','Prioriza el consumo de frutas enteras en lugar de zumos comerciales o caseros.','Si preparas dulces en casa, reduce a la mitad la cantidad de azúcar que indica la receta. También puedes utilizar frutas muy maduras para endulzar.','A medida que vamos reduciendo el consumo de azúcar nuestro paladar se acostumbra y la necesidad de consumirlo cada vez es menor.']},
        {t:'Bebidas', body:'**La mejor opción siempre es el agua,** ya que no contiene alcohol, ni azúcares, ni edulcorantes.\n\nLa Organización Mundial de la Salud recomienda a las personas **beber suficiente agua durante todo el día** para mantenerse hidratadas.\n\n**Trucos para beber más agua:**', bullets:['No compres bebidas azucaradas o alcohólicas de manera habitual.','Ten una botella de agua encima de la mesa durante la comida.','Lleva siempre contigo una botella pequeña de agua para beber durante el día.','Puedes darle sabor al agua agregando frutas como fresas, pepino, hierbas aromáticas, especias o infusiones.']},
        {t:'Lácteos', body:'La Organización Mundial de la Salud recomienda que los lácteos sean parte de una dieta saludable, ya que son una **fuente importante de nutrientes como proteínas, calcio, vitaminas D y B12, y ácido fólico.** Sin embargo, también sugiere que se consuman con moderación y se elijan **opciones bajas en grasa y sin azúcar.**\n\nNo todas las personas pueden o deben consumir lácteos debido a alergias, intolerancias o elecciones dietéticas personales (por ejemplo, veganismo). En estos casos, es esencial asegurarse de obtener suficiente calcio y otros nutrientes a través de fuentes alternativas, como leches vegetales fortificadas y otros alimentos ricos en calcio.'},
      ],
  ...
  function pautasHTML(slug){
    ...
    if(p.type==='cols'){
      ...
      html += `<div class="area-pnum">${p.items.map((it,i)=>{
        const t = (typeof it==='string') ? it : it.t;
        const body = (it && it.body) ? it.body.split(/\n\n+/).filter(s=>s.trim()).map(par=>`<p>${rich(par)}</p>`).join('') : '';
        const bl = (it && it.bullets) ? `<ul>${it.bullets.map(x=>`<li>${rich(x)}</li>`).join('')}</ul>` : '';
        return `<details class="area-acc-item area-pnum-item"><summary><span class="area-pnum-title">${i+1}. ${esc(t)}</span><svg class="area-acc-chev" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg></summary><div class="area-pnum-body">${body}${bl}</div></details>`;
      }).join('')}</div>`;
      if(p.table){
        html += `<div class="area-ptable-static"><div class="area-ptable-title">${esc(p.table.title)}</div><table><tbody>${p.table.rows.map(([g,f])=>`<tr><th scope="row">${esc(g)}</th><td>${esc(f)}</td></tr>`).join('')}</tbody></table></div>`;
      }
  ...
  function renderArea(slug, reporte){
    ...
    // Escalas según el informe: usa escalasByReport si existe (varían inicial/anual), si no las comunes
    const escalas = a.escalasByReport ? (a.escalasByReport[ri] || a.escalasByReport[1]) : (a.escalas || []);
    const escSection = escalas.length
      ? escalas.map(escalaHTML).join('')
